...
class HTMLTest {
	...
	void saveTest1() {
		...
		HTMLFile.builder()
				.lockType(HTMLFile.LockType.NONE)
				.addReports(test_report)
	...
	void saveTestCustomTrailer() {
		...
		HTMLFile.builder()
				...
				.addReports(test_report)
				.filePath(tmpFile.toString())
				.trailer(Functions.customTrailer("<h1>Custom Trailer</h1>"))
				.build()
				.save()
